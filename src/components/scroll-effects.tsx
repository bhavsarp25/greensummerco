...
function SingleVine({ start, end, side, color, strokeWidth }: SingleVineProps) {
  ...
  return (
    <div
      aria-hidden="true"
      className={`pointer-events-none fixed ${positionClass} hidden md:block w-28 md:w-44 lg:w-52 z-0`}
      style={{
...
export function LeafCorners({ sectionRef }: LeafCornersProps) {
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none absolute top-0 left-0 right-0 hidden md:block z-0 overflow-hidden"
      style={{ height: '60vh' }}
    >
      {leftSrc && (
        <motion.img
...
function PhotoVine({ src, start, end, side, mirrored }: PhotoVineProps) {
  ...
  return (
    <div
      aria-hidden="true"
      className={`pointer-events-none fixed ${positionClass} hidden md:block w-32 md:w-44 lg:w-52 z-0 overflow-hidden`}
      style={{
